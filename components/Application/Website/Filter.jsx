                ...
                <AccordionItem value="1">
                    ...
                    <AccordionContent>
                        <div className='max-h-48 overflow-auto'>
                            <ul>
                                {categoryData && categoryData.success && categoryData.data.subCategories && categoryData.data.subCategories.map((category) => (
                ...
                <AccordionItem value="4">
                    ...
                    <AccordionContent>
                        ...
                        <div className='flex justify-between items-center pt-2'>
                            <span>BDT {priceFilter.minPrice.toLocaleString()}</span>
                            <span>BDT {priceFilter.maxPrice.toLocaleString()}</span>
                        </div>
