        ...
        <div className="lg:px-32 px-4">
            ...
            <div className="mb-10">
                <div className="shadow rounded border border-border bg-card">
                    ...
                    <div className="p-3">
                        <div className="text-muted-foreground" dangerouslySetInnerHTML={{ __html: encode(product.description) }}></div>
                    </div>
                </div>
            </div>
            ...
            {product.companyDetails && (
                <div className="mb-10">
                    <div className="shadow rounded border border-border bg-card">
                        ...
                        <div className="p-3">
                            <div className="text-muted-foreground" dangerouslySetInnerHTML={{ __html: encode(product.companyDetails) }}></div>
                        </div>
                    </div>
                </div>
            )}
