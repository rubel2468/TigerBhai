    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Create a new product variant for your store
          </p>
        </div>
        <Button 
          variant="outline" 
          onClick={() => router.push('/vendor/products/variants')}
        >
          Back to Variants
        </Button>
      </div>
      ...
      <Card className="py-0 rounded shadow-sm">
        <CardHeader className="pt-3 px-3 border-b [.border-b]:pb-2">
          <h4 className='text-xl font-semibold'>Product Variant Information</h4>
        </CardHeader>
...
export default dynamic(() => Promise.resolve(AddProductVariant), {
    ssr: false,
