...
export const zSchema = z.object({
    ...
    whatsappLink: z.string().url('Invalid WhatsApp URL format').optional().or(z.literal('')),
    ...
    recommendedFor: z.string().max(120, 'Max 120 characters').optional(),
    ...
    phone: z.string().min(10, 'Phone number is required.').regex(/^[0-9+\-\s()]+$/, 'Invalid phone number format'),
