...
console.log('Loading admin sidebar menu...');
...
console.log('Total menu items:', adminAppSidebarMenu.length);
console.log('Menu items:', adminAppSidebarMenu.map(item => item.title));